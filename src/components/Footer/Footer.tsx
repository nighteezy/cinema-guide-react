    ...
    <footer className="footer">
      <div className="container footer__container">
        <div className="footer__text">
          <span>LLC &laquo;Мультимедиа Визион&raquo;</span>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          <span className="footer__text-rights">Все права защищены</span>
        </div>
        <ul className="list-reset footer__list">
          <li className="footer__item">
            <a className="footer__link" href="https://vk.com">
              <svg
                width="36"
                height="36"
                viewBox="0 0 36 36"
          ...
          <li className="footer__item">
            <a className="footer__link" href="https://ok.ru">
              <svg
                width="36"
                height="36"
                viewBox="0 0 36 36"
          ...
          <li className="footer__item">
            <a className="footer__link" href="https://web.telegram.org">
              <svg
                width="36"
                height="36"
                viewBox="0 0 36 36"
